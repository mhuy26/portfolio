  ...
  return (
    <div style={{ textAlign: "center", padding: "2rem", maxWidth: "95%", margin: "auto" }}>
      ...
      <div style={{ textAlign: "left", maxWidth: "80%", margin: "auto", paddingTop: "1rem" }}>
        <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
      ...
      <div style={{ textAlign: "left", padding: "2rem", maxWidth: "90%", margin: "auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "center", gap: "3rem" }}>
          ...
          <div style={{ paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.6rem", fontWeight: "bold", marginBottom: "1rem" }}>📊 FICO Score & Credit Policy</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
      ...
      <div style={{ textAlign: "left", padding: "2rem", maxWidth: "90%", margin: "auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "center", gap: "3rem" }}>
          ...
          {/* Right: Insights - Added more padding-left */}
          <div style={{ paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.6rem", fontWeight: "bold", marginBottom: "1rem" }}>📉 Interest Rate & FICO Score</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
      ...
      <div style={{ textAlign: "left", padding: "2rem", maxWidth: "90%", margin: "auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "center", gap: "3rem" }}>
          ...
          {/* Right: Insights - Added more padding-left */}
          <div style={{ paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.6rem", fontWeight: "bold", marginBottom: "1rem" }}>📋 Loan Purpose Analysis</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
      ...
      {/* Data Preprocessing */}
      <div style={{ textAlign: "center", padding: "2rem", maxWidth: "95%", margin: "auto" }}>
        <h2 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "1rem" }}>🔄 Data Preprocessing: Handling Categorical Features</h2>
...
final_df.head()`}
          ...
          <div style={{ textAlign: "left", paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.6rem", fontWeight: "bold", marginBottom: "1rem" }}>📌 One-Hot Encoding Categorical Variables</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
        ...
        <p style={{ fontSize: "1.3rem", fontStyle: "italic", textAlign: "center", marginTop: "1.5rem", color: "#E0E0E0" }}>
          Why? 🤔  
...
dtree.fit(X_train, y_train)`}
          ...
          <div style={{ textAlign: "left", paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.7rem", fontWeight: "bold", marginBottom: "1rem" }}>📌 Decision Tree Classifier</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
      ...
      <div style={{ textAlign: "center", padding: "2rem", maxWidth: "90%", margin: "auto" }}>
        <h3 style={{ fontSize: "1.7rem", fontWeight: "bold", marginBottom: "1rem", textAlign: "center" }}>
          📋 Decision Tree Evaluation
        </h3>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "center", gap: "3rem", marginBottom: "2rem" }}>
          ...
          {/* Right: Explanation - Added more padding-left */}
          <div style={{ textAlign: "left", paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.5rem", fontWeight: "bold", marginBottom: "1rem" }}>📌 Key Insights</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "center", gap: "3rem", marginBottom: "2rem" }}>
          ...
          {/* Right: Explanation - Added more padding-left */}
          <div style={{ textAlign: "left", paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.5rem", fontWeight: "bold", marginBottom: "1rem" }}>📊 Confusion Matrix Insights</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
...
rfc.fit(X_train, y_train)`}
          ...
          {/* Right: Explanation - Added more padding-left */}
          <div style={{ textAlign: "left", paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "1.7rem", fontWeight: "bold", marginBottom: "1rem" }}>🌟 Why Random Forest?</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
      ...
      <div style={{ textAlign: "center", padding: "3rem", maxWidth: "90%", margin: "auto" }}>
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: "left", paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "1rem" }}>📌 Key Insights</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: "left", paddingLeft: "2rem" }}>
            <h3 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "1rem" }}>🔍 Confusion Matrix Analysis</h3>
            <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
...
<div style={{ textAlign: "center", padding: "3rem", maxWidth: "90%", margin: "auto" }}>
  ...
  <div style={{ textAlign: "left", maxWidth: "80%", margin: "auto", fontSize: "1.4rem" }}>
    <h3 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "1rem" }}>📌 Key Observations</h3>
  ...
  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "start", gap: "3rem", marginBottom: "2rem" }}>
    ...
    <div style={{ textAlign: "left" }}>
      <h4 style={{ fontSize: "1.8rem", fontWeight: "bold", textAlign: "center", marginBottom: "1rem" }}>✅ Advantages of RF model</h4>
      <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
    ...
    {/* Right: Disadvantages */}
    <div style={{ textAlign: "left" }}>
      <h4 style={{ fontSize: "1.8rem", fontWeight: "bold", textAlign: "center", marginBottom: "1rem" }}>🚨 Disadvantages of RF model</h4>
      <ul style={{ listStyleType: "disc", paddingLeft: "20px", fontSize: "1.3rem" }}>
  ...
  <div style={{ textAlign: "left", maxWidth: "80%", margin: "auto", fontSize: "1.4rem", marginTop: "2rem" }}>
    <h3 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "1rem" }}>🚀 How to Improve?</h3>
    <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
